...
class NEURAL_NETWORK: 
    ...
    def Is_Motor_Neuron(self, neuron_name_given):
        return self.neurons[neuron_name_given].Is_Motor_Neuron()

    def Get_Motor_Neurons_Joint(self, neuron_name_given):
        return self.neurons[neuron_name_given].Get_Joint_Name()

    def Get_Value_Of(self, neuron_name_given):
        return self.neurons[neuron_name_given].Get_Value()
